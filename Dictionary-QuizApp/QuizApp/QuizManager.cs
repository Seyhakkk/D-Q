...
namespace QuizApp
{
    public class QuizManager
    {
        ...
        public void DisplayMainMenu()
        {
            ...
            Console.WriteLine($" <Welcome to Quiz Application> , {currentUser.Username}!");
        ...
        private void InitializeQuestions()
        {
            ...
            easyCategory.AddQuestion(new QuizQuestion("1. Which of the following are elements on the periodic table?\n", new List<string> { "Oxygen", "Hydrogen", "Water", "Carbon" }, new List<int> { 0, 3 }));
            easyCategory.AddQuestion(new QuizQuestion("2. Which of the following are programming languages?\n", new List<string> { "Python", "HTML", "Java", "CSS" }, new List<int> { 0, 2 }));
